  ...
  return (
    <section id="prologue" className="min-h-dvh w-screen bg-black text-blue-50">
      <div className="flex size-full flex-col items-center py-10 pb-24">
        ...
        <div className="mt-10 md:-mt-64 md:me-44 flex w-full justify-center md:justify-end px-4 md:px-0">
          <div className="flex h-full w-fit flex-col items-center md:items-end">
            <p className="mt-3 max-w-xs text-center md:text-right font-circular-web text-violet-50 leading-relaxed">
